...
def _main():
    ext = 'mouse'
    annotation_path = 'train_' + ext + '.txt'
    log_dir = 'logs/'
    classes_path = 'model_data/' + ext + '_classes.txt'
    anchors_path = 'model_data/yolo_anchors_' +  ext + '.txt'
    class_names = get_classes(classes_path)
    num_classes = len(class_names)
    anchors = get_anchors(anchors_path)

    input_shape = (128,384) # multiple of 32, hw
